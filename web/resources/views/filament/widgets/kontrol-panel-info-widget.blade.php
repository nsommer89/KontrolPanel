@php
$ktrl_options_helper = \App\Helpers\KTRLOptionsHelper::getInstance();
@endphp
        ...
        <div class="flex items-center gap-x-3">
            <div class="flex-1">
                <a
                    ...
                    target="_blank"
                >
                    <img style="height: 4rem" src="{{ asset('/static/ktrl_logo_xl.png')  }}" />
                </a>

                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    {{ $ktrl_options_helper->getKTRLVersion() }}
                </p>
            </div>
